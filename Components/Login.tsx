      ...
      {state ? (
        ...
        <div className=' container w-full bg-black m-0  text-web_normal p-5 font-primary'>
          ...
          <div className='footer w-full lg:pt-6 text-center left-0 bottom-0 flex justify-end'>
            ...
            friends and family. You will need their big wallet address. Also,
            let's say you want your family's total crypto assets or your total
            business funds, your friends birthday funds in one place, So, that
            it can be used by anyone among the authorized personnel whenever
            required, Doing this is not possible. Let’s make it flexible to
            share and manage all family, friends, businesses funds in one place
            by collecting them in pots.
          </div>
        </div>
      )}
    </>
